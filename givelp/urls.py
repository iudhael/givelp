...
urlpatterns = [
    ...
    path('manager/', include('entreprise_manager.urls', namespace='entreprise_manager')),
    ...
    path('authentification/password-reset-confirm/(?P<uidb64>[^/]+)/(?P<token>[^/]+)/',
            auth_views.PasswordResetConfirmView.as_view(
                template_name='authentification/password_reset_confirm.html'),
            name="password_reset_confirm"),

    path('authentification/password-reset-complete/',
            auth_views.PasswordResetCompleteView.as_view(template_name='authentification/password_reset_complete.html'),
